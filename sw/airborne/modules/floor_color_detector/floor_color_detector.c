 ...
 * we employ a simple color detector, similar to the 
...
#include "modules/floor_color_detector/floor_color_detector.h"
...
#error Please define FLOOR_COLOR_DETECTOR_VISUAL_DETECTION_ID to be COLOR_OBJECT_DETECTION1_ID or COLOR_OBJECT_DETECTION2_ID in your airframe
#endif
 ...
 */
void floor_color_detector_init(void)
{
 ...
 */
void floor_color_detector_periodic(void)
{
