 ...
 */
/**
 * @file "modules/floor_color_detector/floor_color_detector.c"
 * @author Kirk Scheper
...
extern float leftorright;           // 

extern void mavguys_navigation_init(void);
extern void mavguys_navigation_periodic(void);
